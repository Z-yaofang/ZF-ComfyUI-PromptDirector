...
The repository also includes a test/beta [H3 long-video workflow](docs/LONG_VIDEO_V1_GUIDE.md) with ordinary and C1 MASK examples. It depends on the current MiniMax H3 Audio T8 LOW/HIGH dual-clock graph, and it has not yet been validated on RunningHub.
