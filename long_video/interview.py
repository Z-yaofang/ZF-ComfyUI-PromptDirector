...
FIELDS = set(TEXT_FIELDS) | {"bindings", "media_roles", "media_purposes", "mode", "recipe", "director_focus"}
COMPILED_FINGERPRINT_FIELDS = (
    "segment_id", "reference_plan", "system_prompt", "stage1_task", "stage2_prefix", "stage3_prefix",
...
def compile_segment_interview(plan, raw_state, *, align=False):
    ...
    for segment in plan["segments"]:
        ...
        rows.append({
            ...
            **{key: compiled[key] for key in ("system_prompt", "stage1_task", "stage2_prefix", "stage3_prefix", "duration_seconds", "inventory", "call_references")},
