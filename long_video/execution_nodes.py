...
class ZVLongVideoExecutionEntry:
    ...
    RETURN_TYPES = (
        "ZV_SEGMENT_EXECUTION_CONTEXT", "ZV_H3_REFERENCE_PLAN", "STRING", "STRING", "STRING", "STRING",
        "FLOAT", "INT", "INT", "STRING", "BOOLEAN", "IMAGE", "AUDIO", "INT", "STRING", "STRING",
    )
    RETURN_NAMES = (
        "segment_context", "reference_plan", "system_prompt", "stage1_task", "stage2_prefix", "stage3_prefix",
    ...
    def enter(self, execution_plan, iteration_index, previous_result=None):
        ...
        return (
            context, context["reference_plan"], context["system_prompt"], context["stage1_task"],
            context["stage2_prefix"], context["stage3_prefix"], context["duration_seconds"],
