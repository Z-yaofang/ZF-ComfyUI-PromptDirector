...
MODEL_LEVEL_SPECS = {
    ...
    "2": {
        ...
        "length_factor": 1.0,
        "instruction": (
            "完整表达核心事件、主题素材、用途结构和一个主视觉方法，细节围绕同一观看重点；"
            "人物互动先锁定总人数、相对位置和一个核心动作，每人一个姿态，每只手一个明确任务，"
            "省略与核心动作竞争的重复肢体细节。"
        ),
    },
    "3": {
...
NODE_CLASS_MAPPINGS = {
    ...
    "ZVAnimateSegmentDesk": ZVAnimateSegmentDesk,
...
NODE_DISPLAY_NAME_MAPPINGS = {
    ...
    "ZVSegmentMaskSlice": "ZV H3 当前分段 MASK",
    "ZVH3MaskedSegmentLatent": "ZV H3 蒙版分段 Latent",
    "ZVH3MaskedLatentRestore": "ZV H3 HIGH 蒙版恢复",
    "ZVH3MaskedFrameCompose": "ZV H3 蒙版像素回贴",
    "ZVLongVideoExecutionSetup": "ZV H3 长视频执行准备",
    "ZVLongVideoExecutionEntry": "ZV H3 当前分段执行入口",
    "ZVLongVideoSegmentRecorder": "ZV H3 分段结果落盘",
    "ZVLongVideoExecutionEnd": "ZV H3 长视频精确拼接",
    "ZVAnimateSegmentDesk": "ZV Animate 素材配对台",
